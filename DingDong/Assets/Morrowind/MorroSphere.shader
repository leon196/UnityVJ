    ...
    SubShader {
      ...
      Pass {
        ...
        void geom(triangle GS_INPUT tri[3], inout TriangleStream<FS_INPUT> triStream)
        {
          ...
          float2 uvC = tri[2].uv;
          float3 g = (a + b + c) / 3.0;
          float4 gColor = (tri[0].color + tri[1].color + tri[2].color) / 3.0;
          /*float3 triNormal = getTriangleNormal(a, b, c);*/
          float3 triNormal = normalize(tri[0].normal + tri[1].normal + tri[2].normal);
          ...
          pIn.color = tri[0].color;//half4(1.0,0.0,0.0,1.0);
          ...
          pIn.uv = tri[1].uv;
          pIn.normal = triNormal;
          pIn.color = gColor;//half4(0.0,1.0,0.0,0.0);
          triStream.Append(pIn);
          ...
          pIn.uv = tri[2].uv;
          pIn.normal = triNormal;
          pIn.color = tri[2].color;//half4(0.0,0.0,1.0,1.0);
          triStream.Append(pIn);
          ...
          pIn.uv = tri[2].uv;
          pIn.normal = triNormal;
          pIn.color = tri[2].color;//half4(0.0,1.0,0.0,0.0);
          triStream.Append(pIn);

          pIn.pos =  mul(vp, float4(a, 1.0));
          pIn.uv = tri[0].uv;
          pIn.normal = triNormal;
          pIn.color = tri[0].color;//half4(0.0,0.0,1.0,1.0);
          triStream.Append(pIn);
